...
func SetupPirateAudioButtons(lcdDevice hardware.LCD, synth *synth.Synthesizer, log zerolog.Logger) func() {
	return func() {
		buttons.OnButtonAPressed(func() {
			...
			lcdDevice.ShowTextCentered(canvas, fmt.Sprintf("%0.1f dB", masterGain), volumeFontSize)
