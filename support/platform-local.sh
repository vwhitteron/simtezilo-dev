...
BT_PAIRED_SPEAKER='{"address":"00:11:22:33:44:55","name":"Inbuilt Speakers","type":"speaker","paired":true,"trusted":true,"connected":true,"rssi":-45}'
BT_PAIRED_HEADPHONES='{"address":"66:77:88:99:AA:BB","name":"Wireless Headphones","type":"headphones","paired":true,"trusted":true,"connected":false,"rssi":-62}'
BT_SCAN_SPEAKER='{"address":"CC:DD:EE:FF:00:11","name":"Portable Speaker","type":"speaker","paired":false,"trusted":false,"connected":false,"rssi":-74}'
BT_SCAN_HEADSET='{"address":"22:33:44:55:66:77","name":"Wireless Headset","type":"headset","paired":false,"trusted":false,"connected":false,"rssi":-83}'
...
function handle_bt_scan() {
    ...
    BT_DISCOVERED=''${BT_SCAN_SPEAKER}','${BT_SCAN_HEADSET}''
