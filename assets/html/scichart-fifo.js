async function initSciChart() {
    ...
    const createCharts = async () => {
        ...
        socket.addEventListener('message', (event) => {
            ...
            xyDataSeriesRPM.appendRange([data.timeOfDay], [data.rpm]);
            xyDataSeriesSpeed.appendRange([data.timeOfDay], [data.speed]);
            xyDataSeriesJerk.appendRange([data.timeOfDay], [data.jerk]);
            xyDataSeriesThrottle.appendRange([data.timeOfDay], [data.throttle]);
            xyDataSeriesBrake.appendRange([data.timeOfDay], [data.brake]);
            xyDataSeriesGforce.appendRange([data.timeOfDay], [data.gforce]);
            xyDataSeriescollision.appendRange([data.timeOfDay], [data.collision]);
