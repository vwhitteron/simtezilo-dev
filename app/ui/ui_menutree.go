...
func newMenuTree(hapticsChannels int) *MenuNode {
	menu := branch(menuNodeRoot,
		branch(languagedb.UIMenuLive,
			...
			liveLeaf(languagedb.UIMenuLiveTyres),
			liveLeaf(languagedb.UIMenuLiveLap),
			liveLeaf(languagedb.UIMenuLiveFuel),
		...
		branch(languagedb.UIMenuSettings,
			...
			// The Bluetooth submenu is only visible when an adapter is present.
			branch(languagedb.UIMenuBluetooth,
				leaf(languagedb.UIMenuBluetoothDevice),
				leaf(languagedb.UIMenuBluetoothToggle),
			).setVisibility(PageContextBluetooth),
			...
			branch(languagedb.UIMenuHaptics,
				...
				branch(languagedb.UIMenuHapticsChassis,
					...
					leaf(languagedb.UIMenuHapticsJerkPivot),
					leaf(languagedb.UIMenuHapticsJerkPivotGain),
				...
				branch(languagedb.UIMenuHapticsTransmission,
					...
					leaf(languagedb.UIMenuHapticsTransmissionJerkCurve),
					leaf(languagedb.UIMenuHapticsTransmissionStepBlend),
				),
