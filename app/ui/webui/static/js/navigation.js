...
function createNavigation(currentPage) {
    ...
    navHTML += `
                        <div id="restart-required-indicator" role="button" tabindex="0" style="color: #ff4d4d; font-weight: 600; font-size: 0.875rem; white-space: nowrap; display: none; margin-right: 1rem; cursor: pointer;">
