...
type TelemetryFrame struct {
	...
	SynthChannelAmplitudeL      float32 `json:"synthChannelAmplitudeL"`
	SynthChannelFrequencyL      float32 `json:"synthChannelFrequencyL"`
	SynthChannelAmplitudeR      float32 `json:"synthChannelAmplitudeR"`
	SynthChannelFrequencyR      float32 `json:"synthChannelFrequencyR"`
	...
	MixerChassis0Fill  float32 `json:"mixerChassis0Fill"`
