...
func (a *App) sendTelemetryChartData() {
	...
	go func() {
		a.telemetryChartFeed <- map[string]float32{
			...
			"SixDOFRotationalJerk":        float32(a.kinematics.Current.SixDOFRotation.Jerk),
			"SixDOFRotationalSnap":        float32(a.kinematics.Current.SixDOFRotation.Snap),
			"SixDOFRotationalAccelX":      float32(a.kinematics.Current.SixDOFRotation.Acceleration.X),
			"SixDOFRotationalAccelY":      float32(a.kinematics.Current.SixDOFRotation.Acceleration.Y),
			"SixDOFRotationalAccelZ":      float32(a.kinematics.Current.SixDOFRotation.Acceleration.Z),
