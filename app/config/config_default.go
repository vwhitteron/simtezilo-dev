...
var defaultConfig = viperConfig{
	...
	Haptics: &haptics{
		...
		EngineProfiles: map[string]appHaptics.EngineProfile{
			...
			"v6_b60_c120_rstd":    {PrimaryBalance: 0.80, SecondaryBalance: 0.960, Gain: -2.50, PulseScale: 0.50}, // Renault R.S.01 GT3 '16
			"v6_b75_c120_rstd":    {PrimaryBalance: 0.83, SecondaryBalance: 0.940, Gain: +0.00, PulseScale: 0.50}, // Honda NSX Gr.3
			"v6_b80_c120_rmed":    {PrimaryBalance: 0.62, SecondaryBalance: 0.930, Gain: -3.00, PulseScale: 0.33}, // Mclaren MP4/4 '88
			"v6_b90_c120_rstd":    {PrimaryBalance: 0.80, SecondaryBalance: 0.720, Gain: +0.00, PulseScale: 0.60}, // Toyota GR010 HYBRID '21
			"v6_b90_c120_rhigh":   {PrimaryBalance: 0.85, SecondaryBalance: 0.960, Gain: +0.00, PulseScale: 0.31}, // Red Bull X2019 Competition
			"v6_b120_c120_rlow":   {PrimaryBalance: 0.75, SecondaryBalance: 0.880, Gain: +0.00, PulseScale: 0.50}, // Audi R18 TDI '11
			"v8":                  {PrimaryBalance: 0.86, SecondaryBalance: 0.980, Gain: -4.00, PulseScale: 0.55}, // REF v8_b90_c90
			"v8_b90_c180_rstd":    {PrimaryBalance: 0.78, SecondaryBalance: 0.980, Gain: -5.00, PulseScale: 0.33}, // Nissan R92CP '92
			"v8_b90_c180_rmed":    {PrimaryBalance: 0.86, SecondaryBalance: 0.980, Gain: -3.00, PulseScale: 0.30}, // Toyota TS030 Hybrid '12
			"v8_b90_c90_rstd":     {PrimaryBalance: 0.86, SecondaryBalance: 0.980, Gain: -4.00, PulseScale: 0.55}, // M6 GT3 Endurance Model '16
			"v10":                 {PrimaryBalance: 0.88, SecondaryBalance: 0.965, Gain: -2.00, PulseScale: 0.25}, // REF v10_b72_c72
			"v10_b72_c72_rstd":    {PrimaryBalance: 0.86, SecondaryBalance: 0.940, Gain: -1.50, PulseScale: 0.25}, // ** Lexus LFA '10
			"v10_b90_c72_rstd":    {PrimaryBalance: 0.86, SecondaryBalance: 0.940, Gain: +0.00, PulseScale: 0.33}, // Lamborghini Huracan GT3 '16
			"v10_b90_c72_rmed":    {PrimaryBalance: 0.86, SecondaryBalance: 0.940, Gain: +0.00, PulseScale: 0.33}, // ** Dodge SRT Tomahawk VGT (Gr.1)
			"v12":                 {PrimaryBalance: 0.99, SecondaryBalance: 0.995, Gain: -2.00, PulseScale: 0.25}, // REF v12_b60_c120
			"v12_b60_c120_rstd":   {PrimaryBalance: 0.90, SecondaryBalance: 0.990, Gain: +0.00, PulseScale: 0.30}, // ** Ferrari 512 BB '76
			"v12_b60_c120_rmed":   {PrimaryBalance: 0.90, SecondaryBalance: 0.990, Gain: +0.00, PulseScale: 0.30}, // Mclaren F1 GTR - BMW '95
			"v12_b60_c120_rhigh":  {PrimaryBalance: 0.80, SecondaryBalance: 0.960, Gain: -1.50, PulseScale: 0.33}, // Gran Turismo 1500T-A
			"v12_b75_c120_rstd":   {PrimaryBalance: 0.80, SecondaryBalance: 0.990, Gain: -1.00, PulseScale: 0.30}, // V12 Vantage GT3 '12
			"v12_b100_c120_rhigh": {PrimaryBalance: 0.80, SecondaryBalance: 0.980, Gain: -1.00, PulseScale: 0.20}, // Peugeot HDi FAP '10
			"v12_b144_c120_rstd":  {PrimaryBalance: 0.80, SecondaryBalance: 0.970, Gain: -1.50, PulseScale: 0.12}, // SRT Tomahawk X VGT
			"w16":                 {PrimaryBalance: 0.80, SecondaryBalance: 0.990, Gain: -3.50, PulseScale: 0.20}, // Bugatti Veyron Gr.4
			...
			"h12":                 {PrimaryBalance: 0.98, SecondaryBalance: 0.990, Gain: +0.00, PulseScale: 0.25}, // ** Porsche 917K '70
			"k2":                  {PrimaryBalance: 0.85, SecondaryBalance: 0.960, Gain: +0.00, PulseScale: 0.33}, // ** Mazda RX-7 Spirit R Type A (FD) '02
