...
var defaultConfig = viperConfig{
	...
	Haptics: &haptics{
		...
		EngineProfiles: map[string]appHaptics.EngineProfile{
			...
			"v10_b72_c72":  {PrimaryBalance: 0.86, SecondaryBalance: 0.940, Gain: -1.50, PulseScale: 0.25},
			"v10_b90_c72":  {PrimaryBalance: 0.86, SecondaryBalance: 0.940, Gain: -1.50, PulseScale: 0.25},
