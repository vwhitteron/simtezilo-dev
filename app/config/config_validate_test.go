...
func TestValidateJSONSchema_HapticsOutOfRange(t *testing.T) {
	...
	tests := []struct {
		...
		{"jerkPivot too low", "jerkPivot", `"jerkPivot": 0`},
		{"jerkPivot too high", "jerkPivot", `"jerkPivot": 20001`},
		{"jerkPivotGain too low", "jerkPivotGain", `"jerkPivotGain": -12.5`},
		{"jerkPivotGain too high", "jerkPivotGain", `"jerkPivotGain": 0.5`},
