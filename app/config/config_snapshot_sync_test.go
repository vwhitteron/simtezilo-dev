...
var snapshotMutators = map[string]func(cfg *Config){
	...
	"SetHapticsJerkPivot":                   func(cfg *Config) { cfg.SetHapticsJerkPivot(900) },
	"IncreaseHapticsJerkPivot":              func(cfg *Config) { cfg.IncreaseHapticsJerkPivot() },
	"DecreaseHapticsJerkPivot":              func(cfg *Config) { cfg.DecreaseHapticsJerkPivot() },
	"SetHapticsJerkPivotGain":               func(cfg *Config) { cfg.SetHapticsJerkPivotGain(-6.5) },
	"IncreaseHapticsJerkPivotGain":          func(cfg *Config) { cfg.IncreaseHapticsJerkPivotGain() },
	"DecreaseHapticsJerkPivotGain":          func(cfg *Config) { cfg.DecreaseHapticsJerkPivotGain() },
	...
	"SetHapticsTransmissionJerkCurve":       func(cfg *Config) { cfg.SetHapticsTransmissionJerkCurve(400) },
	"IncreaseHapticsTransmissionJerkCurve":  func(cfg *Config) { cfg.IncreaseHapticsTransmissionJerkCurve() },
	"DecreaseHapticsTransmissionJerkCurve":  func(cfg *Config) { cfg.DecreaseHapticsTransmissionJerkCurve() },
	"SetHapticsTransmissionStepBlend":       func(cfg *Config) { cfg.SetHapticsTransmissionStepBlend(0.3) },
	"IncreaseHapticsTransmissionStepBlend":  func(cfg *Config) { cfg.IncreaseHapticsTransmissionStepBlend() },
	"DecreaseHapticsTransmissionStepBlend":  func(cfg *Config) { cfg.DecreaseHapticsTransmissionStepBlend() },
