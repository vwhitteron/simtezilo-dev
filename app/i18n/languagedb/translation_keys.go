...
const (
	...
	RadioTyresOverTempFront Key = "radio.tyresovertempfront"
	RadioTyresOverTempRear  Key = "radio.tyresovertemprear"
	RadioTyreOverTempFL     Key = "radio.tyreovertempfl"
	RadioTyreOverTempFR     Key = "radio.tyreovertempfr"
	RadioTyreOverTempRL     Key = "radio.tyreovertemprl"
	RadioTyreOverTempRR     Key = "radio.tyreovertemprr"
)
